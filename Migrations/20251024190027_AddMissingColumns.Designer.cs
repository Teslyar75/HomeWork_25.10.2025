...
namespace ASP_421.Migrations
{
    ...
    [Migration("20251024190027_AddMissingColumns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("ASP_421.Data.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.ProductGroup", b =>
                {
                    b.HasOne("ASP_421.Data.Entities.ProductGroup", "Parent")
                        .WithMany()
